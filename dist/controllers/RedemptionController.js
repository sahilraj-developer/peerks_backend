...
exports.createRedemption = exports.getActiveRedemptions = exports.getRedemptions = void 0;
...
const getActiveRedemptions = async (req, res) => {
    const userId = req.user?.id;
    if (!userId)
...
exports.getActiveRedemptions = getActiveRedemptions;
